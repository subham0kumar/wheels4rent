  ...
  return (
    <div className="font-rubik">
      ...
      <div className="lg:mx-40 mx-6">
        <div className="flex flex-col lg:flex-row lg:mr-20 mt-20">
          ...
          <div className="text-center pt-10 space-y-4">
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
              <span className="flex flex-col items-center">
                ...
                <span className="flex flex-col lg:flex-row gap-3 items-center mt-3">
              ...
              <span className="flex flex-col items-center ">
                <img
                  ...
                  width={60}
                />
                <span className="flex flex-col lg:flex-row gap-2 items-center mt-4">
