...
const VehicleContext = ({ children }) => {
  const vehicleModels = [
    ...
    },
    {
      ...
      isAc: "No",
      imgUrl: "/static/tata-tiago-white.png",
      pricePerDay: "1000",
      stars: 3,
    },
    {
