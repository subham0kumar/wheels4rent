...
const TestimonialSection = () => {
  return (
    <section className="font-poppins z-50 py-20 h-fit flex flex-col items-center">
      <aside className="space-y-4 text-center lg:mx-64">
        <h3 className="text-lg lg:text-2xl font-bold font-rubik">
          Reviewed by People
        </h3>
      ...
      <main className="flex flex-col lg:flex-row lg:gap-20 lg:mx-4">
        {/* review Card  */}
        <div className="container-concentric bg-Gbay-50 flex justify-between flex-col text-center lg:text-justify lg:w-1/2 shadow-[0_10px_15px_0_rgba(54,44,166,0.5)] rounded p-6 lg:p-14 mt-10 space-y-6">
          <h3 className="text-lg lg:text-2xl font-semibold mb-4">
            "We rented a car from this website and had an amazing experience!
            The booking was easy and the rental rates were very affordable. "
          </h3>
          <div className="font-rubik flex items-center lg:justify-start justify-center gap-3">
            <IoManSharp
              size={45}
              className="border p-2 rounded-full bg-Gbay-100"
            />
            <span>
